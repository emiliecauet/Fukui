...
directory = "/Users/ecauet/Documents/METASPACE/Fukui-Model/Molecules-Test/TESTS/FPID_1384/Forces/"
Bondlimit = 2.8
#Factor = 0.52918
...
def project(N, list_atom, list_coord, list_gradient, list_bonds):
    ...
    print 'list_bonds: ', list_bonds
    print 'list_indexat1: ', list_indexat1
    print 'list_indexat2: ', list_indexat2
...
for f in os.listdir(myfolder):
    if f.endswith("NA.inp"):
        ...
        outfrag_force = open(os.path.join(myfolder+"frag_outF"+str(f)[-7:-4]), "w")
        outfrag_proj = open(os.path.join(myfolder+"frag_outP"+str(f)[-7:-4]), "w")
        ...
        print 'AN_atoms: ', AN_atoms
        print 'AN_atomsXYZ: ', AN_atomsXYZ
