...
directory = "/Users/ecauet/Documents/METASPACE/Fukui-Model/Compounds-Alex/Compound1/Forces/"
Bondlimit = 3.2
#Factor = 0.52918
...
#                    list_final += [round(ProjX, 3), round(ProjY, 3), round(ProjZ, 3)]
                    ...
                    tmplst2=[]                    
                    tmplst2 = [list_atom[i][0],list_atom[j][0], i, j, list_coord[i][0], list_coord[i][1], list_coord[i][2], Bond, Force, ScalarProj, theta, '{:.5f}'.format(ProjX), '{:.5f}'.format(ProjY), '{:.5f}'.format(ProjZ)]
...
#            print>>frag_file, listAN_weight, "\n"
        ...
        frag1 = fg.FragmenterBasic(AN_atoms, AN_forces, AN_newbonds, AN_atomsXYZ, breakage_threshold=0.99, breakage_threshold_absolute=False, fragmentation_depth=2, Group_Atom_Numbers=False)
